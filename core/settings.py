...
SECRET_KEY = 'django-insecure-zhj)a_rcufn63^@q$%izh!b6wcddwy7@vay@x9afa_0iu!k61-'
...
AUTH_USER_MODEL = 'usuario.User' #extender ese modelo o utilizar un modelo personalizado.
